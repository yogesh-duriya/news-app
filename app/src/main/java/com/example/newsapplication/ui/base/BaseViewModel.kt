...
import com.example.newsapplication.data.remote.toBaseException
import com.example.newsapplication.utils.SingleLiveEvent
    ...
    protected open fun onError(throwable : Throwable){
        when(throwable) {
            ...
            is SocketTimeoutException -> {
                ...
                // convert thrwable to base exception to get error information
